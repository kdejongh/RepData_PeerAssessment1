...
To substitute the missing values the mean value for the interval across all days is taken. If no values are found for that interval 0 is taken.
...
The following plots shows the 5-minute interval (x-axis) and the average number of steps taken, averaged across all weekend days (y-axis)[plot 1] and across all weekdays [plot 2].
